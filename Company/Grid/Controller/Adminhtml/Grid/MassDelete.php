<?php
/**
 * Company Grid Record Delete Controller.
 * @category  Company
...
use Company\Grid\Model\ResourceModel\Grid\CollectionFactory;
...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Company_Grid::row_data_delete');
    }
}
